    ...
    <footer className="bg-huriky-black border-t border-gray-800">
      <div className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-medium mb-4 text-sm uppercase tracking-wider text-gray-400">Service</h3>
          ...
          <div>
            <h3 className="font-medium mb-4 text-sm uppercase tracking-wider text-gray-400">Resources</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} HurikyNetwork. All rights reserved.
          </p>
